...
describe('buildFilterSubQuery', () => {
	...
	test('it should return query with 1 test', () => {
		...
		const query = filterBuilder.buildFilterSubQuery(filters['maxPrice'], config.filterConfig['maxPrice'], 'gift1'); 
	...
	test('it should return query with 2 tests', () => {
		...
		const query = filterBuilder.buildFilterSubQuery(filters['forPersons'], config.filterConfig['forPersons'], 'gift1'); 
	...
	test('it should return query with multiple tests', () => {
		...
		const query = filterBuilder.buildFilterSubQuery(filters['complex'], config.filterConfig['complex'], 'gift1'); 
